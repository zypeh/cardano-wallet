        ...
        readCurrentTip wid >>= \case
            Just tip -> do
                ...
                inSubmissionsRaw <- withSubmissions wid [] $ \submissions -> do
                        pure $ getInSubmissionTransactions_ submissions
