...
import Cardano.Wallet.DB.Store.TransactionsWithCBOR.Model qualified as TxStore
...
mkTxHistoryWithCBORs cs =
    TxHistoryWithCBOR (mkTxHistory cs) $
        TxCBORHistory $
            Map.fromList
