...
import Cardano.Ledger.Era qualified as Ledger.Era
...
import Cardano.Ledger.Shelley qualified as SL hiding
    ( Value
    )
...
import Cardano.Wallet.Primitive.Types.Redeemer qualified as W
