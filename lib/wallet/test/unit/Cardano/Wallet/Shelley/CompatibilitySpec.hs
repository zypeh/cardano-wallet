...
import Cardano.Ledger.Shelley qualified as SLAPI
...
import Cardano.Wallet.Primitive.AddressDerivation qualified as AddressDerivation
...
instance
    ...
    => Arbitrary (AddressDerivation.Index derivationType depth)
    where
...
instance
    (WalletKey k, Arbitrary (k 'CredFromKeyK XPrv))
